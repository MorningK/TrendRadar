...
from .crawler.data_fetcher import DataFetcher
from .analyzer.data_processor import read_all_today_titles, detect_latest_new_titles, load_frequency_words
from .analyzer.statistics_calculator import count_word_frequency
from .reporter.report_generator import generate_html_report
from .notifier.notification_sender import send_to_notifications
...
class NewsAnalyzer:
    ...
    def _check_version_update(self) -> None:
        """检查版本更新"""
        from .utils.time_utils import check_version_update
        try:
    ...
    def _crawl_data(self) -> Tuple[Dict, Dict, List]:
        ...
        from .analyzer.data_processor import save_titles_to_file
